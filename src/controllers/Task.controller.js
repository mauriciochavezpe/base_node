...
const deleteTask = async function (req, res) {
    ...
    try {
        ...
        return res.json({ mesagge: "Se elimino exitosamente" })
    } catch (error) {
        return res.status(412).json({ mesagge: "Error mientras se eliminaba " + error.message })
    }
}
const updateTask = async function (req, res) {
    ...
    try {
        ...
        res.json({ mesagge: "Se actualizo exitosamente" })
    } catch (error) {
        res.status(412).json({ mesaggex: "Error mientras se eliminaba " + error.message })
    }
}
module.exports = {
    getTasks,
